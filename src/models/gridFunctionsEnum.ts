enum gridFunctionsEnum {
  showNumberColumns = 'showNumberColumns',
  showDateColumns = 'showDateColumns',
  navigateToProductDetails_RequestCaseId = 'navigateToProductDetails_RequestCaseId',
  showTrueFalseColumns = 'showTrueFalseColumns',
  navigateToPurchaseDetails_purchaseOrderId = 'navigateToPurchaseDetails_purchaseOrderId',
  actionEditColumn = 'actionEditColumn',
  actionEditAndRemoveColumn = 'actionEditAndRemoveColumn',
