...
import {AddNewPerson, AddNewProject, UpdatePerson, UpdateProject} from "../../redux/features/definitionSlicer.ts";
...
export const AddPerson = ({addPersonsDialog,selectedPerson,onClose}) => {
    ...
    return (
        <Dialog open={addPersonsDialog} onClose={onClose} fullWidth={true} maxWidth={'md'} fullScreen={mediumOrSmaller}>
