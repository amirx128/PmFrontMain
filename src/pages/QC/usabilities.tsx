...
import { GetAllUsabilityAction } from "../../redux/features/qcSlicer.ts";
...
const UsabilitiesListQC = () => {
  ...
  const { usabilities } = useSelector((state: any) => state.qc);
  ...
  const getList = async () => {
    dispatch(GetAllUsabilityAction());
  };
...
export default UsabilitiesListQC;
