            ...
            <Grid item xs={12}>
                <Box sx={{
                    ...
                    <Grid container spacing={1}>
                        {
                            projects?.data?.length > 0 ? projects?.data?.map(project => <ProjectCard setSelectedProject={setSelectedProject} setAddProjectDialog={setAddProjectDialog} project={project} key={project?.id} />) : 'no data'
                        }
                    </Grid>
                </Box>
            </Grid>
