...
import {
  DownloadFinancialQAction,
  GetFinancialQAction,
} from "../../redux/features/purchaseSlicer.ts";
import gridDict from "../../dictionary/gridDict.ts";
import { Link, useNavigate } from "react-router-dom";
import SimCardDownloadIcon from "@mui/icons-material/SimCardDownload";
import { DownloadFinalApproveQAction } from "../../redux/features/supportSlicer.ts";
...
const FinancialQueue = () => {
  ...
  const {
    ...
    handleSelectAll,
  } = useCustomCol("FINANCIALS_QUEUE", purchaseColumns);
  useEffect(() => {
    getList();
  }, []);
  ...
  const getList = async () => {
    ...
    await dispatch(GetFinancialQAction(body));
  };
